...
(DEFCONSTANT JPEG-OPTIMIZE #x20000)
(DEFCONSTANT JPEG-BASELINE #x40000)
...
(DEFCONSTANT WEBP-DEFAULT 0)
(DEFCONSTANT WEBP-LOSSLESS #x100)

(DEFCONSTANT JXR-DEFAULT 0)
(DEFCONSTANT JXR-LOSSLESS #x0064)
(DEFCONSTANT JXR-PROGRESSIVE #x2000)
...
(CFFI:DEFCENUM FREE-IMAGE-FORMAT (:FIF-UNKNOWN -1) (:FIF-BMP 0) (:FIF-ICO 1)
               ...
               (:FIF-PICT 33) (:FIF-RAW 34) (:FIF-WEBP 35) (:FIF-JXR 36)) 
